(function () {
	...
	var heroCurrent = 100;
	var heroTarget = 100;
	var cachedHeroRect = null; // Bolt ⚡: Cache rect to prevent layout thrashing
	...
	var updateHeroWidth = function (clientX) {
		// Bolt ⚡: Use cached rect to prevent synchronous layout recalculation on every mouse move
