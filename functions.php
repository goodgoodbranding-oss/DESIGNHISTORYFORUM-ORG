...
function dhf_get_article_prompt_context( $post_id, $content ) {
	...
	// Bolt optimization: use get_the_terms() and wp_list_pluck() instead of wp_get_post_terms() to leverage the object cache and prevent N+1 database query bottlenecks.
